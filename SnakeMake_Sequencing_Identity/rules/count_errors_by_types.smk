...
rule identity_error_stats:
    input:
        stats = "{output_name}/IDENTITY_{output_name}_full_{read_type}.tsv.gz"
    output:
        error_stats = "{output_name}/IDENTITY_{output_name}_full_{read_type}.tsv.gz.error.stats"
    params:
