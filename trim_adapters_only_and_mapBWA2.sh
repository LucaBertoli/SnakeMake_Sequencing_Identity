...
$fastp -i $R1 -I $R2 -o trimmed1.fastq.gz -O trimmed2.fastq.gz --failed_out failed.fastq.gz --overrepresentation_analysis -h adapters_removal_report.html -w $thread --disable_quality_filtering --disable_length_filtering
